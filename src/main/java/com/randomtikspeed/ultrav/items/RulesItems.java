package com.randomtikspeed.ultrav.items;
...
public class RulesItems {
    ...
    private void createNullItem() {
        ...
        meta.setDisplayName(Component.text(""));
    ...
    private void createClose() {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(instance.getMsgUtils().Colour("&cClose"));
        item.setItemMeta(meta);
        close = item;
    }
    // Back
    ...
    private void createMCRules() {
        ...
        ItemMeta meta = item.getItemMeta();
        meta.setDisplayName(Component.text("§aMinecraft Rules"));
        List<Component> lore = new ArrayList<>();
        lore.add(Component.text("§7Click to check out"));
        lore.add(Component.text("§7the Minecraft server"));
        lore.add(Component.text("§7rules!"));
        meta.setLore(lore);
    ...
    private void createDCRules() {
        ...
        List<Component> lore = new ArrayList<>();
        lore.add(Component.text("§7Click to check out"));
        lore.add(Component.text("§7the Discord server"));
        lore.add(Component.text("§7rules!"));
        meta.setLore(lore);
        meta.addEnchant(Enchantment.LUCK, 1, false);
        meta.addItemFlags(ItemFlag.HIDE_ENCHANTS);
